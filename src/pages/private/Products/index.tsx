...
import { TableColumnType, PageHeader, Button, Table, Col, Row, notification } from "antd";
import api from "../../../api";
...
const Products: React.FC<ProductsProps> = () => {
  ...
  return (
    <Container data-testid="container-el">
      ...
      <AddProduct onCancel={() => setIsVisibleModal(false)} isVisible={isVisibleModal} onSubmit={onHandleReloadData} />
    </Container>
  );
};
